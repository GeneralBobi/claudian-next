...
contextBridge.exposeInMainWorld('claudian', {
  ...
  connectorDesktopDrag: () => invoke('connector:desktop-drag'),
  connectorDesktopReveal: () => invoke('connector:desktop-reveal'),
  ...
  companionLocalUpdate: (id,change) => invoke('companion:local-update',id,change),
  ...
  startLocalSetup: () => invoke('app:setup-local'),
